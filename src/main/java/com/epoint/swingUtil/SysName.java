...
public class SysName extends JPanel
{
    ...
    *//**
    ...
    public SysName(String sqlurl, String sqltype) {
        this.sqlurl = sqlurl;
    ...
    public void LoadList() {
        try {
            ...
            String sql = "select CONFIGVALUE from frame_config where configname='sysname'";
    ...
    public void save() {
        try {
            ZtbCommonDao db = new ComFunction().getService(sqltype, sqlurl);
            String sql = "update frame_config set CONFIGVALUE='" + field1.getText() + "' where configname='sysname'";
            db.execute(sql);
        }
        catch (Exception e) {
            e.getMessage().toString();
